...
- Listing: Sample listings with realistic names, locations, and prices.
- Booking: Bookings associated with listings and users.
- Review: Reviews attached to listings with ratings and comments.
